define({ 
  ...
  */
  getPresenter:function(eventID){
    try{
      ...
      var objectInstance = sdkClient.getObjectService("EventOrchSDO", {"access": "online"});
      ...
      var options = {
        ...
        "headers": {},
        "queryParams": {"$filter": "event_id eq "+"'"+eventID+"'"}
      };
  ...
  */
  presenterFetchSuccess:function(response){
    ...
    var mDate,mDay;
    var sessionStartDayString,sessionEndDayString;
    for(var i=0;i<listLength;i++){
      ...
      segSectionObject={
        ...
        "lblMonth":monthString[mDate.getMonth()],
        "lblVerticalLine":" ",
        "lblEventAddress":location,
        "lblEventDateTime":dayString[mDay]+", "+sessionStartDayString[1]+" - "+sessionEndDayString[1]
      };
  ...
  */
  presenterFetchFailure:function(response){
    ...
    alert("Error occured while fetching the presenters: "+JSON.stringify(response));
  },
  /**

...
function getEventType(eventTypeCode){
  ...
  switch(eventTypeCode){
    case "1":eventType="online";break;
    case "2":eventType="offline";break;
    default:eventType="";
  }
  return eventType;
}
function getEventCategory(eventCategoryCode){
  ...
  switch(eventCategoryCode){
    case "1":eventCategory="Training";break;
    case "2":eventCategory="Workshops";break;
    case "3":eventCategory="Hackathon";break;
    case "4":eventCategory="Speaker Series";break;
    case "5":eventCategory="Conference";break;
    case "6":eventCategory="Special Events";break;
    default:
      eventCategory="";
  }
...
var record={
  "opstatus_queryeventregistration8141":0,"opstatus_queryevent8579":0,"opstatus_queryusers2939":0,"opstatus":0,
  "event_banners":[
    {
    ...
    },
    {
      ...
      "addressLine1":"Phoneix avnace",
      "location":"Kony india pvt LTD",
      "location_id":74,"longitude":"78.37137229999999"
    }
  ],
  "event":[
    {
      "end_date":"2018-05-13 23:59:00.0",
      "event_id":1,"event_type":2,"isdisabled":0,"name":"Women's Day Celebration",
      "short_desc":"A woman is an epitome of beauty, wisdom and care",
      "event_category":1,"long_desc":"She has climbed the mountains and dived into the ocean; she has matched the steps with every man in the world.",
    ...
    ,
    {
      ...
      "event_id":2,"event_type":1,"isdisabled":0,"name":"Git for Visualizer Projects",
      "short_desc":"The cross-platform nature of Visualizer makes for a very complex project anatomy",
      "event_category":1,"long_desc":"During this webinar, we\u2019ll try to address some of these questions and help you get started with \u2014or get better at\u2014 using Git as a versioning tool for Visualizer projects.",
      "start_date":"2018-05-05 09:00:00.0"
    },
    {
      "end_date":"2018-06-13 01:00:00.0",
      "event_id":3,"event_type":2,"isdisabled":0,"name":"Kony Developer Bootcamp",
      ...
      "event_category":2,"long_desc":"This 2 week course covers everything from using widgets, services, and the Kony API to develop the mobile application to server-side development to extending the application through Kony's Foreign Function Interface.",
      "start_date":"2018-06-13 09:00:00.0"
    },
    {
      "end_date":"2018-05-20 23:59:00.0",
      "event_id":4,"event_type":2,"isdisabled":0,"name":"Kony Knowledge Week",
      ...
      "event_category":3,"long_desc":"The articles cover a wide range of topics, including security, components, integrations and more",
      "start_date":"2018-05-16 00:00:00.0"
    },
    {
      "end_date":"2018-05-30 17:00:00.0",
      "event_id":36,"event_type":2,"isdisabled":0,"name":"Kony Developer Bootcamp",
      "event_category":1,"long_desc":"This week focuses on Kony Visualizer to define and design the user interface, and on the fundamental skills for creating, configuring, managing, and maintaining mobile apps using Kony Visualizer and Kony Fabric.",
      "start_date":"2018-05-29 08:00:00.0"
    },
    {
      "end_date":"2018-07-26 16:00:00.0",
      "event_id":39,"event_type":2,"isdisabled":0,"name":"Containers and Docker",
      "event_category":1,"long_desc":"Hands-on exercise with Docker on the container format that is now a de facto standard used by all major cloud   providers",
      "start_date":"2018-07-26 16:00:00.0"
    },
    {
      "end_date":"2018-04-25 02:00:00.0",
      "event_id":59,"event_type":2,"isdisabled":1,"name":"Test Event",
      "short_desc":"Test Short Description",
      "event_category":1,"long_desc":"Test Long Description",
      "start_date":"2018-04-24 02:00:00.0"
    },
    {
      "end_date":"2018-04-11 00:00:00.0",
      "event_id":60,"event_type":1,"isdisabled":1,"name":"test sample",
      "short_desc":"sampel",
      "event_category":1,"long_desc":"sample",
    ...
    ,
    {
      ...
      "user_id":9,"profile":"https://media.licdn.com/dms/image/C5103AQGJAijuGQ6UDg/profile-displayphoto-shrink_100_100/0?e=1528023600&v=alpha&t=tq6SRbZsKXUyC-TyhWVcOVkYZP5YTrBzrSsJ4dHvSJc",
      "last_name":"karunanithi",
      "login_mode":1,"first_name":"vigneshwaran"
    }
  ],"httpStatusCode":0,"event_registration":[
    {
      "event_id":1,"user_id":1,"registration_id":01
    },
    {
      "event_id":82,"user_id":1,"registration_id":11
    }
    ,
    {
      "event_id":82,"user_id":7,"registration_id":12
    }
    ,
    {
      "event_id":82,"user_id":9,"registration_id":13
    },
    {
      "event_id":82,"user_id":8,"registration_id":14
    }
    ,
    {
      "event_id":4,"user_id":7,"registration_id":21
    }
    ,
    {
      "event_id":3,"user_id":7,"registration_id":22
    }
    ,
    {
      "event_id":1,"user_id":7,"registration_id":23
    }
    ,
    {
      "event_id":2,"user_id":9,"registration_id":25
    }
    ,
    {
      "event_id":4,"user_id":9,"registration_id":28
    }
  ]
};